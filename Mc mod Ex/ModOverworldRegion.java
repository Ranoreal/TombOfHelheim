...
public class ModOverworldRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint,
        ...
        this.addModifiedVanillaOverworldBiomes(mapper, modifiedVanillaOverworldBuilder -> {
            modifiedVanillaOverworldBuilder.replaceBiome(Biomes.SWAMP, ModBiomes.HELHEIM_FOREST);


            //VanillaParameterOverlayBuilder builder = new VanillaParameterOverlayBuilder();
            // Overlap Vanilla's parameters with our own for our Helheim biome.
            ...
            //        .build().forEach(point -> builder.add(point, ModBiomes.HELHEIM_FOREST));
//
